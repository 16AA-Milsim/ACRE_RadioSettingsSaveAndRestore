...
[(typeOf _unit), 1, ["ACE_SelfActions", "ACRE_Interact"], _settingsBranch] call ace_interact_menu_fnc_addActionToClass;
...
[(typeOf _unit), 1, ["ACE_SelfActions", "ACRE_Interact", "Settings_Branch"], _instructionsAction] call ace_interact_menu_fnc_addActionToClass;
...
[(typeOf _unit), 1, ["ACE_SelfActions", "ACRE_Interact", "Settings_Branch"], _showRadioSettingsAction] call ace_interact_menu_fnc_addActionToClass;
...
[(typeOf _unit), 1, ["ACE_SelfActions", "ACRE_Interact", "Settings_Branch"], _restoreRadioSettingsBranch] call ace_interact_menu_fnc_addActionToClass;
...
[(typeOf _unit), 1, ["ACE_SelfActions", "ACRE_Interact", "Settings_Branch", "Restore_Radio_Settings_Branch"], _confirmAction] call ace_interact_menu_fnc_addActionToClass;
...
[(typeOf _unit), 1, ["ACE_SelfActions", "ACRE_Interact", "Settings_Branch"], _saveRadioSettingsBranch] call ace_interact_menu_fnc_addActionToClass;
// Confirm Save action
_confirmStatement = {
